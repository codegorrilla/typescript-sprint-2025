...
var coordinate = function (point) {
    console.log("The co-ordinates are ".concat(point.x, "degree, ").concat(point.y, "degree"));
};
var coord2 = function (point) {
    console.log("The co-ordinates are ".concat(point.x, "degree, ").concat(point.y, "degree and ").concat(point.z, "degree"));
};
